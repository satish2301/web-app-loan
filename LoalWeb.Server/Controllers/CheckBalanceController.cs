...
namespace LoalWeb.Server.Controllers
{
    ...
    public class CheckBalanceController : ControllerBase
    {
        ...
        private readonly ILogger<CheckBalanceController> logger;
        ...
        public string POST([FromBody] string reqData)
        {
            ...
            var option = new RestClientOptions("https://api.dialmytrip.com/api/Services/DMTCheckBalance")
            {
                MaxTimeout = -1,
            };
            var client = new RestClient(option);

            var request = new RestRequest("https://api.dialmytrip.com/api/Services/DMTCheckBalance", Method.Post);
