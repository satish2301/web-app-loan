...
const PersonalLoan = () => {
  ...
  const [titleName, setTitleName] = useState("PL");
      ...
      {submitStatus ? (
        ...
        <>
          ...
          <Row className={`my-4`} gutter={[24, 24]}>
            ...
            <Col md={12} xs={24}>
              <div class="inputBox">
                <input type="text" class="inputText" id="emi" placeholder="" />
                <label class="label" for="emi">
                  Current Monthly EMIs (Optional)
                </label>
              </div>
            </Col>
            <Col md={12} xs={24}>
          ...
          <Row className="justify-content-center" gutter={[12, 12]}>
            <Col md={6} xs={24}>
